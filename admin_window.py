...
class jobs:
    def __init__(self, root):
        ...
        backbtn.place(relx=0.1, rely=0.5, relwidth=0.18, relheight=0.08)
        ...
        combo_Search['values'] = ( "Qualification", "job")
        ...
        self.Job_table.heading("company", text="username")
        self.Job_table.heading("salary", text="email")
